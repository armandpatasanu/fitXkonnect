...
class PersonalMatchCard extends StatefulWidget {
  final snap;
  const PersonalMatchCard({
    Key? key,
    required this.snap,
  }) : super(key: key);

  @override
  State<PersonalMatchCard> createState() => _PersonalMatchCardState();
}

class _PersonalMatchCardState extends State<PersonalMatchCard> {
  var userData = {};
